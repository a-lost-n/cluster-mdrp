...
def calculateDelay(now, goal, extra_time=0):
   full_actual = datetime.datetime(1,1,1,now.hour,now.minute,now.second)
   full_goal = datetime.datetime(1,1,1,goal.hour,goal.minute,goal.second)
